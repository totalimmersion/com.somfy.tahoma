...
const CapabilitiesXRef = [
    ...
    },
    {
        ...
        somfyNameSet: ['setComfortTemperature'],
    },
    {
        homeyName: 'target_temperature.eco_heating',
        somfyNameGet: 'core:EcoRoomTemperatureState',
        somfyNameSet: ['setEcoTemperature'],
    },
    {
        homeyName: 'target_temperature.derogated',
        somfyNameGet: 'core:DerogatedTargetTemperatureState',
        somfyNameSet: ['setDerogatedTargetTemperature'],
    },
    {
        homeyName: 'cancel_heating',
        somfyNameGet: '',
        somfyNameSet: ['cancelHeatingLevel'],
    },
    {
        homeyName: 'regulation_mode_state',
        somfyNameGet: 'core:RegulationModeState',
        somfyNameSet: [],
    },
    {
        homeyName: 'power_state',
        somfyNameGet: 'io:PowerState',
        somfyNameSet: [],
    },
    {
        homeyName: 'native_function_level_state',
        somfyNameGet: 'io:NativeFunctionalLevelState',
        somfyNameSet: [],
    },
    {
    ...
    {
        homeyName: 'occupancy_activation',
        somfyNameGet: 'core:OccupancyActivationState',
        somfyNameSet: ['setOccupancyActivation'],
        compare: ['inactive', 'active'],
    },
    {
        homeyName: 'open_window_activation',
        somfyNameGet: 'core:OpenWindowDetectionActivationState',
        somfyNameSet: ['setOpenWindowDetectionActivation'],
        compare: ['inactive', 'active'],
    },
    {
