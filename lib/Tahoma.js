...
class Tahoma extends Homey.SimpleClass
{
     ...
     *
     */
    static async executeDeviceAction(name, deviceUrl, action, action2)
    {
        if (Homey.app.loggedIn)
        {
            if (deviceUrl)
    ...
    {
        if (executionId && Homey.app.loggedIn)
        {
            ...
            if (await this.registerEvents())
            {
                ...
                try
                {
                    ...
                    if (Homey.app.infoLogEnabled)
                    {
                        if (events.length > 0)
                        {
                            Homey.app.logInformation("Fetching Events",
                            {
                                message: "Complete",
                                stack: events
                            });
                        ...
                        {
                            Homey.app.logInformation("Fetching Events", "Complete");
                        }
                    }
                ...
                {
                    this.registerResponse = null;
                    Homey.app.logInformation("Fetching Events Error",
                    {
