...
module.exports = class HttpHelper extends SimpleClass
{
    constructor(Homey)
    {
        ...
        this.setBaseURL(this.homey.ManagerSettings.get('linkurl'));
        return this;
    }
    ...
    async reAuthenticate()
    {
        ...
        const linkURL = this.homey.ManagerSettings.get('linkurl');
        const loginMethod = this.homey.ManagerSettings.get('loginMethod');
